...
__attribute__((weak)) float _sin(float a) {
  // 16bit integer array for sine lookup. interpolation is used for better
  // precision 16 bit precision on sine value, 8 bit fractional value for
  // interpolation, 6bit LUT size resulting precision compared to stdlib sine is
  // 0.00006480 (RMS difference in range -PI,PI for 3217 steps)
